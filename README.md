...
Personal poetry website. Built with **FastAPI** backend, **Vanilla JS** SPA frontend, **PostgreSQL** database, served via **Nginx**, deployed with **Docker Compose**.
...
- DNS record: `A www.yourdomain.com → YOUR_VPS_IP` (also add `A yourdomain.com → YOUR_VPS_IP`)
...
Check it works at http://www.yourdomain.com
...
docker compose run --rm certbot certonly \
  ...
  -d www.yourdomain.com -d yourdomain.com \
...
Your site is now live at https://www.yourdomain.com 🎉
...
1. Go to https://www.yourdomain.com, click **Login** (top right)
